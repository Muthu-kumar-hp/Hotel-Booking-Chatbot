...
import { MapPin, BedDouble, Star, CloudSun } from 'lucide-react';
...
export function HotelDetailCard({ hotel, onQuickReply }: HotelCardProps) {
  ...
  const handleWeather = () => {
    onQuickReply(`What's the weather at ${hotel.name}?`);
  };
  ...
  return (
    <div className="bg-card rounded-lg overflow-hidden flex flex-col gap-4 p-4">
        ...
        <div className="mt-2 grid grid-cols-1 gap-2">
             <Button onClick={handleWeather} variant="outline">
        ...
        <Button onClick={handleBookNow} size="lg" className="mt-2">
